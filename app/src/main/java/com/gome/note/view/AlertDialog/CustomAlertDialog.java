package com.gome.note.view.AlertDialog;
...
public class CustomAlertDialog extends Dialog implements DialogInterface {
    ...
    /**
     * Special theme constant for {@link #CustomAlertDialog(Context, int)}: use the
    ...
    /**
     * Construct an CustomAlertDialog that uses an explicit theme. The actual style
     * that an CustomAlertDialog uses is a private implementation, however you can
     * here supply either the name of an attribute in the theme from which to
     * get the dialog's style (such as {@link android.R.attr#alertDialogTheme}
    ...
    static int resolveDialogTheme(Context context, int resId) {
        if (resId == 0) {
            return R.style.Theme_GOME_Light_Dialog_Alert;
        } else {
            return resId;
        }
    }
    ...
    public static class Builder {
         ...
         * {@link CustomAlertDialog} it creates. The actual theme that an CustomAlertDialog
         * uses is a private implementation, however you can here supply either
         * the name of an attribute in the theme from which to get the dialog's
         * style (such as {@link android.R.attr#alertDialogTheme} or one of the
         * constants {@link CustomAlertDialog#THEME_TRADITIONAL
         * CustomAlertDialog.THEME_TRADITIONAL}, {@link CustomAlertDialog#THEME_HOLO_DARK
         * CustomAlertDialog.THEME_HOLO_DARK}, or {@link CustomAlertDialog#THEME_HOLO_LIGHT
         * CustomAlertDialog.THEME_HOLO_LIGHT}.
         */
        public Builder(Context context, int theme) {
            P = new CustomAlertController.AlertParams(new ContextThemeWrapper(
         ...
         *
         * @param attrId
         *            ID of a theme attribute that points to a drawable
         *            resource.
         */
        ...
        /**
         * Creates a {@link CustomAlertDialog} with the arguments supplied to this
        ...
        public CustomAlertDialog create() {
            final CustomAlertDialog dialog = new CustomAlertDialog(P.mContext, mTheme);
