package com.gome.note.view.tag;
...
public class EditPocketLabelsTagLayout extends FlowTagLayout {

    private static final String TAG = EditPocketLabelsTagLayout.class.getSimpleName();
     ...
     */
     int mTagCheckMode = FLOW_TAG_CHECKED_NONE;

    /**
     * add tag
     */
    SparseBooleanArray mCheckedTagArray = new SparseBooleanArray();

    public EditPocketLabelsTagLayout(Context context) {
        super(context);
    }

    public EditPocketLabelsTagLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public EditPocketLabelsTagLayout(Context context, AttributeSet attrs, int defStyleAttr) {
...
//                //换行
    ...
    protected void onLayout(boolean changed, int l, int t, int r, int b) {
        ...
        // traversal controls, record each sub view position
        for (int i = 0, childCount = getChildCount(); i < childCount; i++) {
            View childView = getChildAt(i);
            ...
            //Since the child View may set margin, here is the margin distance
            MarginLayoutParams mlp = (MarginLayoutParams) childView.getLayoutParams();
                ...
                public void onClick(View v) {
                    if (mTagCheckMode == FLOW_TAG_CHECKED_NONE) {
                        if (mOnTagClickListener != null) {
                            mOnTagClickListener.onItemClick(EditPocketLabelsTagLayout.this, childView, j);
                        }
                        ...
                        if (mCheckedTagArray.get(j)) {
                            ...
                            if (mOnTagSelectListener != null) {
                                mOnTagSelectListener.onItemSelect(EditPocketLabelsTagLayout.this, new ArrayList<Integer>());
                            }
                            return;
                        }
                        ...
                        if (mOnTagSelectListener != null) {
                            mOnTagSelectListener.onItemSelect(EditPocketLabelsTagLayout.this, Arrays.asList(j));
                        }
                    } else if (mTagCheckMode == FLOW_TAG_CHECKED_MULTI) {
                        if (mCheckedTagArray.get(j)) {
                            mCheckedTagArray.put(j, false);
                        ...
                        if (mOnTagSelectListener != null) {
                            ...
                            mOnTagSelectListener.onItemSelect(EditPocketLabelsTagLayout.this, list);
                        }
                        if (mOnTagClickListener != null) {
                            mOnTagClickListener.onItemClick(EditPocketLabelsTagLayout.this, childView, j);
                        }
