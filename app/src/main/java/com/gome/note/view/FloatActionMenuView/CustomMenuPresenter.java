...
public interface CustomMenuPresenter {
    /**
    ...
    public interface Callback {
         ...
         */
        public boolean onOpenSubMenu(CustomMenuBuilder subMenu);
    }

    /**
     * Initialize this presenter for the given context and menu.
     * This method is called by MenuBuilder when a presenter is
     * added. See {@link CustomMenuBuilder#addMenuPresenter(CustomMenuPresenter)}
     *
     ...
     * {@link #initForMenu(Context, CustomMenuBuilder)}.
     *
