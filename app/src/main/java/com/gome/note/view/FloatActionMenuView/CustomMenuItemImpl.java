...
public class CustomMenuItemImpl implements MenuItem {
    ...
    public int color = 0; //GiOs4.0_BEGIN $lixin10130312 $20160218
    ...
    private CustomSubMenuBuilder mSubMenu;
     ...
     */
    CustomMenuItemImpl(CustomMenuBuilder menu, int group, int id, int categoryOrder, int ordering,
    ...
    void setSubMenu(CustomSubMenuBuilder subMenu) {
        mSubMenu = subMenu;
    ...
    /**
     * Gets the title for a particular {@link CustomMenuView.ItemView}
     *
     ...
     *         prefers
     */
    CharSequence getTitleForItemView(CustomMenuView.ItemView itemView) {
        ...
        if (mActionProvider != null) {
            mActionProvider.setVisibilityListener(new ActionProvider.VisibilityListener() {
                @Override public void onActionProviderVisibilityChanged(boolean isVisible) {
                    mMenu.onItemVisibleChanged(CustomMenuItemImpl.this);
                }
            });
        }
        return this;
