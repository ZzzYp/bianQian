...
public class CustomAlertController  {
    ...
    public CustomAlertController(Context context, DialogInterface di, Window window) {
        ...
        TypedArray a = context.obtainStyledAttributes(null,
                ...
                R.attr.gomeAlertDialogStyle, 0);

        mAlertDialogLayout = a.getResourceId(R.styleable.AlertDialog_layout,
                R.layout.gome_alert_dialog);
//        mListLayout = a.getResourceId(
//                R.styleable.AlertDialog_listLayout,
//                R.layout.gome_select_dialog);
        mMultiChoiceItemLayout = a.getResourceId(
                R.styleable.AlertDialog_multiChoiceItemLayout,
                R.layout.gome_select_dialog_multichoice);
        mSingleChoiceItemLayout = a.getResourceId(
                R.styleable.AlertDialog_singleChoiceItemLayout,
                R.layout.gome_select_dialog_singlechoice);
        mListItemLayout = a.getResourceId(
                R.styleable.AlertDialog_listItemLayout,
                R.layout.gome_select_dialog_item);
        a.recycle();
    ...
    private void setupView() {
        ...
        TypedArray a = mContext.obtainStyledAttributes(
                null, R.styleable.AlertDialog, R.attr.gomeAlertDialogStyle, 0);
...
//        }
    ...
    /*public static class RecycleListView extends GomeMaxListView {
    ...
    public static class AlertParams {
        ...
        private void createListView(final CustomAlertController dialog) {
            ...
            listView.setListViewHeight(580);
            ListAdapter adapter;
