...
public class CustomMenuBuilder implements Menu {
     ...
     */
    private ArrayList<CustomMenuItemImpl> mActionItems;
    /**
     * Contains items that should NOT appear in the Action Bar, if present.
     */
    private ArrayList<CustomMenuItemImpl> mNonActionItems;
    ...
    private ArrayList<CustomMenuItemImpl> mTempShortcutItemList = new ArrayList<CustomMenuItemImpl>();

    private CopyOnWriteArrayList<WeakReference<CustomMenuPresenter>> mPresenters =
            new CopyOnWriteArrayList<WeakReference<CustomMenuPresenter>>();

    /**
     * Currently expanded menu item; must be collapsed when we clear.
     */
    private CustomMenuItemImpl mExpandedItem;
    ...
    public CustomMenuBuilder(Context context) {
        mContext = context;
        mResources = context.getResources();

        mItems = new ArrayList<CustomMenuItemImpl>();

        mVisibleItems = new ArrayList<CustomMenuItemImpl>();
        mIsVisibleItemsStale = true;

        mActionItems = new ArrayList<CustomMenuItemImpl>();
        mNonActionItems = new ArrayList<CustomMenuItemImpl>();
        mIsActionItemsStale = true;

        setShortcutsVisibleInner(true);
    }

    public CustomMenuBuilder setDefaultShowAsAction(int defaultShowAsAction) {
     ...
     * {@link #removeMenuPresenter(CustomMenuPresenter)}.
     *
     * @param presenter The presenter to add
     */
    public void addMenuPresenter(CustomMenuPresenter presenter) {
     ...
     */
    public void addMenuPresenter(CustomMenuPresenter presenter, Context menuContext) {
        mPresenters.add(new WeakReference<CustomMenuPresenter>(presenter));
     ...
     */
    public void removeMenuPresenter(CustomMenuPresenter presenter) {
        for (WeakReference<CustomMenuPresenter> ref : mPresenters) {
            final CustomMenuPresenter item = ref.get();
    ...
    private void dispatchPresenterUpdate(boolean cleared) {
        ...
        for (WeakReference<CustomMenuPresenter> ref : mPresenters) {
            final CustomMenuPresenter presenter = ref.get();
            if (presenter == null) {
                mPresenters.remove(ref);
            } else {
    ...
    private boolean dispatchSubMenuSelected(CustomSubMenuBuilder subMenu,
                                            CustomMenuPresenter preferredPresenter) {
    ...
    public void saveActionViewStates(Bundle outStates) {
        ...
        for (int i = 0; i < itemCount; i++) {
            ...
            if (item.hasSubMenu()) {
                final CustomSubMenuBuilder subMenu = (CustomSubMenuBuilder) item.getSubMenu();
    ...
    private MenuItem addInternal(int group, int id, int categoryOrder, CharSequence title) {
        ...
        final CustomMenuItemImpl item = createNewMenuItem(group, id, categoryOrder, ordering, title,
    ...
    private CustomMenuItemImpl createNewMenuItem(int group, int id, int categoryOrder, int ordering,
                                           CharSequence title, int defaultShowAsAction) {
        return new CustomMenuItemImpl(this, group, id, categoryOrder, ordering, title,
                defaultShowAsAction);
    }
    ...
    public SubMenu addSubMenu(int group, int id, int categoryOrder, CharSequence title) {
        final CustomMenuItemImpl item = (CustomMenuItemImpl) addInternal(group, id, categoryOrder, title);
        final CustomSubMenuBuilder subMenu = new CustomSubMenuBuilder(mContext, this, item);
    ...
    void setExclusiveItemChecked(MenuItem item) {
        ...
        for (int i = 0; i < N; i++) {
            CustomMenuItemImpl curItem = mItems.get(i);
    ...
    public void setGroupCheckable(int group, boolean checkable, boolean exclusive) {
        ...
        for (int i = 0; i < N; i++) {
            CustomMenuItemImpl item = mItems.get(i);
    ...
    public int findGroupIndex(int group, int start) {
        ...
        for (int i = start; i < size; i++) {
            final CustomMenuItemImpl item = mItems.get(i);
    ...
    private static int findInsertIndex(ArrayList<CustomMenuItemImpl> items, int ordering) {
    ...
    public void dispatchMenuItemNumberChanged(){
        if(mCallback != null){
            mCallback.onMenuItemNumberChanged(getVisibleItems().size());
        }
    }

    public boolean performShortcut(int keyCode, KeyEvent event, int flags) {
        final CustomMenuItemImpl item = findItemWithShortcutForKey(keyCode, event);
     ...
     * with the keyCode.
     */
    void findItemsWithShortcutForKey(List<CustomMenuItemImpl> items, int keyCode, KeyEvent event) {
        ...
        for (int i = 0; i < N; i++) {
            CustomMenuItemImpl item = mItems.get(i);
            if (item.hasSubMenu()) {
                ((CustomMenuBuilder)item.getSubMenu()).findItemsWithShortcutForKey(items, keyCode, event);
            }
     ...
     */
    CustomMenuItemImpl findItemWithShortcutForKey(int keyCode, KeyEvent event) {
        // Get all items that can be associated directly or indirectly with the keyCode
        ArrayList<CustomMenuItemImpl> items = mTempShortcutItemList;
        items.clear();
    ...
    public boolean performItemAction(MenuItem item, CustomMenuPresenter preferredPresenter, int flags) {
        CustomMenuItemImpl itemImpl = (CustomMenuItemImpl) item;
        ...
        if (itemImpl.hasCollapsibleActionView()) {
            ...
            if (!itemImpl.hasSubMenu()) {
                itemImpl.setSubMenu(new CustomSubMenuBuilder(getContext(), this, itemImpl));
            }

            final CustomSubMenuBuilder subMenu = (CustomSubMenuBuilder) itemImpl.getSubMenu();
    ...
    /**
     * Called by {@link CustomMenuItemImpl} when its visible flag is changed.
     * @param item The item that has gone through a visibility change.
     */
    void onItemVisibleChanged(CustomMenuItemImpl item) {
    ...
    /**
     * Called by {@link CustomMenuItemImpl} when its action request status is changed.
     * @param item The item that has gone through a change in action request status.
     */
    void onItemActionRequestChanged(CustomMenuItemImpl item) {
        // Notify of items being changed
        mIsActionItemsStale = true;
        onItemsChanged(true);
    }

    public ArrayList<CustomMenuItemImpl> getVisibleItems() {
    ...
    public void flagActionItems() {
        ...
        final ArrayList<CustomMenuItemImpl> visibleItems = getVisibleItems();
    ...
    public ArrayList<CustomMenuItemImpl> getActionItems() {
        flagActionItems();
        return mActionItems;
    }
     ...
     * @hide
     */
    public ArrayList<CustomMenuItemImpl> getNonActionItems() {
        flagActionItems();
     ...
     */
    protected CustomMenuBuilder setHeaderTitleInt(CharSequence title) {
     ...
     * @return This MenuBuilder so additional setters can be called.
     */
    protected CustomMenuBuilder setHeaderTitleInt(int titleRes) {
     ...
     * @return This MenuBuilder so additional setters can be called.
     */
    protected CustomMenuBuilder setHeaderIconInt(Drawable icon) {
     ...
     * @return This MenuBuilder so additional setters can be called.
     */
    protected CustomMenuBuilder setHeaderIconInt(int iconRes) {
     ...
     * @return This MenuBuilder so additional setters can be called.
     */
    protected CustomMenuBuilder setHeaderViewInt(View view) {
    ...
    public CustomMenuItemImpl getExpandedItem() {
